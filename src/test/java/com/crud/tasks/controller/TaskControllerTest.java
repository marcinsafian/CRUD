...
public class TaskControllerTest {
    ...
    public void shouldFetchEmptyTasksList() throws Exception {
        ...
        //When & Then
        mockMvc.perform(get("/v1/task_crud/tasks/getTasks").contentType(MediaType.APPLICATION_JSON))
    ...
    public void shouldFetchTaskWhichDoesNotExist() throws Exception {
        ...
        //When & Then
        mockMvc.perform(get("/v1/task_crud/1")
    ...
    public void shouldFetchTask() throws Exception {
        ...
        //When & Then
        mockMvc.perform(get("/v1/task_crud/tasks/1")
                .contentType(MediaType.APPLICATION_JSON)
                .characterEncoding("UTF-8")
                .param("taskId", "1"))
                .andExpect(status().is(200))
    ...
    public void shouldDeleteTaskWhichDoesNotExist() throws Exception {
        ...
        //When & Then
        mockMvc.perform(delete("/v1/task_crud/tasks/1")
                .contentType(MediaType.APPLICATION_JSON)
                .characterEncoding("UTF-8")
                .param("taskId", "1"))
    ...
    public void shouldUpdateTask() throws Exception {
        ...
        //When & Then
        mockMvc.perform(put("/v1/task_crud/tasks/updateTask")
                .contentType(MediaType.APPLICATION_JSON)
                .characterEncoding("UTF-8")
                .content(jsonContent))
    ...
    public void shouldCreateTask() throws Exception {
        ...
        //When & Then
        mockMvc.perform(post("/v1/task_crud/tasks/createTask")
                .contentType(MediaType.APPLICATION_JSON)
                .characterEncoding("UTF-8")
                .content(jsonContent))
                .andExpect(status().is(200));
